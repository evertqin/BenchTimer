...
/**
 * Created by ruogu on 10/1/14.
 */
public class SQLiteProcessor extends SQLiteOpenHelper {
    ...
    public SQLiteProcessor(Context context) {
    ...
    public List<StepEntry> queryProtocolDetail(int id) throws IllegalArgumentException {
